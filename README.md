...
- `GET /products`, `GET /products/:id`, `GET /products/slug/:slug` — public, and they only ever
  see `ACTIVE` products; a draft or archived one answers `404`.
...
is permanent and therefore allowed for drafts only; published products are archived instead.
